...
%----------------------------------------------------------------------------------------
	\section{Summary}
	\textbf{Quantitative Analyst} with a \textbf{PhD in Applied Mathematics}, specializing in stochastic control, numerical methods, and machine learning for financial applications.
	Experienced in developing and implementing quantitative models through an industrial PhD (French CIFRE program) bridging academic research and industry.
	...
	\begin{joblong}{Quantitative Researcher \& Analyst — Exiom Partners (Jun. 2021 - Present)}{}
		...
		\begin{itemize}
			...
			\item Conduct research on numerical and learning-based methods for stochastic control, with applications to pricing, optimal stopping, and market making.
			\item Develop and analyze theoretically grounded and computationally efficient algorithms combining stochastic control, machine learning, and reinforcement learning.
			\item Co-author research papers and present results at international conferences. 
			\item Supervised research internships on deep hedging and state-of-the-art reinforcement learning approaches for optimal stopping problems. \\
		\end{itemize}
