...
%----------------------------------------------------------------------------------------
	\section{Summary}
	\textbf{Quantitative Analyst} with a \textbf{PhD in Applied Mathematics}, specializing in stochastic control, numerical methods, and machine learning applied to finance.
	...
	\begin{joblong}{Quantitative Researcher \& Analyst — Exiom Partners (Jun. 2021 - Present)}{}
		...
		\item[$\bullet$] \textbf{Doctoral Researcher (Industry-Sponsored PhD, CIFRE)} \hfill Jun. 2022 -- Dec. 2025
		\begin{itemize}
