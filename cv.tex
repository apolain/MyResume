...
%----------------------------------------------------------------------------------------
	...
	\item PhD researcher (Laboratoire de Mathématiques et Modélisation d'Évry (LaMME)):
		\begin{itemize}
			\item[$\bullet$] Conduct research on numerical and learning-based methods for stochastic control, with applications to pricing, optimal stopping, and market making.
			\item[$\bullet$] Develop and analyze algorithms that are both theoretically grounded and computationally efficient, combining stochastic control theory, machine learning, and reinforcement learning techniques.
			\item[$\bullet$] Co-author research papers and present results at international conferences. 
			\item[$\bullet$] Supervised research internships on deep hedging and state-of-the-art reinforcement learning approaches for optimal stopping problems. \\
		\end{itemize}
		
	\item Working as a part-time Quant in industry, contributing to projects in risk and model development:
		\begin{itemize}
